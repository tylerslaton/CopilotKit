    ...
    >
        ...
        >
            ...
            <Step>
                ...
                Now we need to install the dependencies for the frontend and the agent. This repo comes with a helper function to do this for you.

                <Callout type="info">
                    This LlamaIndex agent uses pip and manages the installation of dependencies through a package.json script, `install:agent`.
                </Callout>
        ...
        >
            <Step>
                ### Serve your LlamaIndex agent as an AG-UI endpoint
