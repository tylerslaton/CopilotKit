...
Read more about the approach to HITL in LlamaIndex Agents.
  ...
  cards={[
    {
      ...
      title: "Tool-based",
      description:
        "Utilize LlamaIndex Agents to create Human-in-the-Loop workflows.",
      href: "/llamaindex/human-in-the-loop/tool-based",
    },
  ]}
/> 