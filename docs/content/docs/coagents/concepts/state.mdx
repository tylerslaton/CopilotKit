---
title: Shared State
description: Co-agents maintain a shared state across your UI and agent execution.
---
...
Co-agents maintain a shared state that seamlessly connects your UI with the agent's execution. This shared state system allows you to:
...
operations. While the core shared state reflects the agent's current node in the execution graph, the predicted state provides immediate
...
Want help implementing this into your Agentic Copilots? Check out our [intermediate state streaming](/coagents/advanced/intermediate-state-streaming)
documentation.
