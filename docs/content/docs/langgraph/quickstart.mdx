                    ...
                    <Step>
                        ...
                        <Tabs groupId="language" items={["Python", "TypeScript"]}>
                            <Tab value="Python">
                                ...
                                poetry install
                                ```
                                When using the langgraph CLI, since it uses the system python environment, you also need to run
                                ```bash
                                pip install -e .
                                ```
                            </Tab>
            ...
            >
                ...
                >
                    ...
                    <Step>
                        ...
                        <Callout type="info">
                            Looking for a way to run multiple LangGraph agents? Check out our [Multi-Agent](/langgraph/multi-agent-flows) guide.
                        </Callout>
                    </Step>
                </TailoredContentOption>
                <TailoredContentOption
...
<Cards>
  ...
  <Card
    ...
    href="/langgraph/generative-ui/agentic"
    icon={<PaintbrushIcon />}
  />
  <Card
