    ...
    >
        ...
        >
            ...
            <Step>
                ...
                <Callout type="info">
                    This Agno agent uses pip and manages the installation of dependencies through a package.json script, `install:agent`.
                </Callout>
        ...
        >
            <Step>
                ### Serve your Agno agent as an AG-UI endpoint
