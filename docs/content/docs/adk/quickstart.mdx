    ...
    >
        ...
        >
            <Step>
                ...
                ADK's integration relies on [AG-UI](https://docs.ag-ui.com/), as such
            ...
            <Step>
                ...
                CopilotKit's runtime is responsible for secure communication between your agent and your frontend. As you progress
                with your application, this will be where you'll do things like set up threads or authentication.
            ...
            <Step>
                ...
                The CopilotKit provider component is responsible for managing the session with your current agent. Typically,
                ...
                export default function RootLayout({ children }: { children: ReactNode }) {
                  return (
                    <html lang="en">
                      <body>
                {/* This points to the runtime we set up in the previous step */} // [!code highlight:4]
