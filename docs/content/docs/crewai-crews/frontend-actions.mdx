...
<Callout>
Check out the [Frontend Actions overview](/(root)/frontend-actions) to understand what they are and when to use them.
</Callout>
...
<Steps>
    <Step>
        ...
        Check out our [getting started guide](/crewai-crews/quickstart) and come back here when you're set up!
    </Step>
